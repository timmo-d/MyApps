#adapted from: https://github.com/szymonzaczek/towards-data-science/blob/master/twitter_sentiment_visualisation_pipeline/twitter_sentiment_visualisation_pipeline.py
...
def main():
    ...
    tweets_text = get_tweets(keywords, date_for_query)
    sentiment_list = get_sentiment(tweets_text)
    plot_sentiment(sentiment_list, keywords, date_for_query)

def get_tweets(keywords, date_for_query):
    while True:
...
def plot_sentiment(sentiment_list, keywords, date_for_query):
    ...
    save_plot(fig, keywords)

def save_plot(fig, keywords):
    fig.savefig(
